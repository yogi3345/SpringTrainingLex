...
@Configuration
@EnableJpaRepositories(basePackages = "com.infosys.irs.repository")
@PropertySource("classpath:/com/infosys/irs/resources/application.properties")
public class PersistenceContext {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan("com.infosys.irs");
