		...
		<div class="container  col-sm-5 col-right " style="width:40%">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form:form method="POST" action="authenticateAdminLogin"
					...
					Language : <a href="?locale=en">English</a>|<a href="?locale=hi">Hindi</a>|<a href="?locale=fr">French</a>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
								<spring:message code="login.pwd" text="default text"/>
									<form:input type="password" path="password" required="true" title="Password must contain 5 to 15 characters"
										class="form-control" pattern=".{5,15}"/>
